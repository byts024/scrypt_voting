...
const contract_id = {
  ...
  txId: "adb6fa9f3aae20e01db32f7b010ff5819387b61db1fc020b6669deb4a49361b3",
  /** The output index */
  outputIndex: 0,
};
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h2>What's your favorite language?</h2>
      </header>
      <TableContainer
        component={Paper}
        variant="outlined"
      ...
      >
        <Table>
          <TableHead>
            <TableRow>
              <TableCell align="center">Rust</TableCell>
              <TableCell align="center">Golang</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <TableRow>
              <TableCell align="center">
                <Box>
                  <Box
                    ...
                    component="img"
                    alt={"Rust"}
                    src={`${process.env.PUBLIC_URL}/${"rust"}.jpg`}
                  />
                </Box>
              </TableCell>
              <TableCell align="center">
